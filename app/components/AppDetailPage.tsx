      ...
      <Box padding="space-24" borderRadius="8" background="raised" borderColor="neutral-subtle" borderWidth="1">
        <VStack gap="space-20">
          ...
          <HGrid gap="space-16" columns={{ xs: 2, md: 3, lg: 5 }}>
            ...
            <StatCard label="Venter verifisering" value={deploymentStats.pending_verification} variant="warning" compact />
            <StatCard
                  ...
                  <HStack gap="space-16" align="center" justify="space-between" wrap>
                    <VStack gap="space-4">
                      ...
                      <Detail textColor="subtle">
                        Generert: {new Date(report.generated_at).toLocaleDateString('nb-NO')} • {report.pr_approved_count}{' '}
                        PR, {report.manually_approved_count} manuell
                      </Detail>
                    </VStack>
                    <HStack gap="space-8">
