...
import { getAllUsersWithAccounts, getOrCreateUserFromDirectory } from '~/db/user-github-lookups.server'
...
export async function action({ request }: Route.ActionArgs) {
  ...
  if (intent === 'assign') {
    ...
    let userMapping: Awaited<ReturnType<typeof getOrCreateUserFromDirectory>>
    try {
      userMapping = await getOrCreateUserFromDirectory(navIdent)
    } catch (err) {
