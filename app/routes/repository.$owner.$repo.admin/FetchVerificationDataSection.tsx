...
import type { GitHubDataStats } from '~/db/github-data.server'
      ...
      <VStack gap="space-16">
        <div>
          ...
          <BodyShort textColor="subtle" size="small">
            Henter og lagrer data fra GitHub for alle deployments knyttet til dette repositoryet. Kjører kun for
            deployments som mangler data eller har utdatert schema-versjon.
          </BodyShort>
        </div>
        ...
        <HStack gap="space-16" align="center">
          <Form method="post">
            ...
            >
              {fetchJobStatus?.status === 'running' ? 'Henter data...' : 'Hent data for alle apper i repoet'}
            </Button>
          </Form>
          ...
          >
            <VStack gap="space-8">
              <HStack gap="space-8" align="center">
                {fetchJobStatus.status === 'running' && <Loader size="xsmall" title="Henter data fra GitHub..." />}
              ...
              <HStack gap="space-8" align="center">
                ...
                {fetchJobStatus.id && (
                  <AkselLink
                    as={Link}
                    to={`/repository/${githubOwner}/${githubRepoName}/admin/sync-job/${fetchJobStatus.id}?repositoryId=${repositoryId}`}
                  >
