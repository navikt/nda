...
RUN pnpm exec tsc server.ts auth-middleware.ts app/lib/security-headers.ts app/lib/app-context.ts --module nodenext --moduleResolution nodenext --target es2022 --esModuleInterop
...
COPY --from=builder /app/app/lib/security-headers.js ./app/lib/
COPY --from=builder /app/app/lib/app-context.js ./app/lib/
